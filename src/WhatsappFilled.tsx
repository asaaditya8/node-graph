...
const WhatsAppOutlined: React.FC<any> = (props) => {
    ...
    return (
        <span role='img' aria-label='import' className={className} {...restProps}>
            <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" height="25" width="25" viewBox="-93.2412 -156.2325 808.0904 937.395">
                <defs>
                    ...
                    <linearGradient xlinkHref="#a" id="f" x1="270.265" y1="1.184" x2="270.265" y2="541.56" gradientTransform="scale(.99775 1.00225)" gradientUnits="userSpaceOnUse" />
                    <linearGradient xlinkHref="#b" id="g" x1="279.952" y1=".811" x2="279.952" y2="560.571" gradientTransform="scale(.99777 1.00224)" gradientUnits="userSpaceOnUse" />
                ...
                <g fill="none" fill-rule="evenodd">
                    <g transform="matrix(1 0 0 -1 -542.696 1013.504)" fill="#000" fill-rule="nonzero" filter="url(#c)">
                        ...
                        <use fill-opacity=".2" xlinkHref="#e" width="100%" height="100%" />
                    </g>
